...
rdtfiles_l = [
	...
	("mult", "-mult_rdt", "skyline.porder_2.mult.rdt", "MultAdd: matrix->MultAdd(...). Multiply matrix by another matrix.")
]

def short_description() : return "skyline-multadd -- cube1.txt -- polinomial order 2"
...
def setup_cmd():
	...
	# Check run directory
	rundir = os.path.join(builddir,'scripts','skyline_tst07')
