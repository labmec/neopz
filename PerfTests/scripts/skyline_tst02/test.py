...
rdtfiles_l = [
	...
	("clk", "-clk_rdt", "clk.rdt", "Cholesky Decomposition: matrix->Decompose_Cholesky(). Decompose matrix using Cholesky Decomposition."),
	("sfwd", "-sfwd_rdt", "sfwd.rdt", "Substitute Forward: matrix->Substitute_Forward()."),
	("sbck", "-sbck_rdt", "sbck.rdt", "Substitute Backward: matrix->Substitute_Backard().")
]

def short_description() : return "skyline tests -- cube1.txt -- polinomial order 3"
