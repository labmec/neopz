...
rdtfiles_l = [
	# short_name, option, filename, description
        ("ldlt", "-ldlt_rdt", "skyline.porder_3.ldlt.rdt", "LDLt Decomposition: matrix->Decompose_LDLt(). Decompose matrix using LDLt Decomposition.")
]

def short_description() : return "skyline-decompose_ldlt -- cube1.txt -- polinomial order 3"
