...
rdtfiles_l = [
	...
	("clk", "-clk_rdt", "skyline.porder_3.clk.rdt", "Cholesky Decomposition: matrix->Decompose_Cholesky(). Decompose matrix using Cholesky Decomposition."),
	("sfwd", "-sfwd_rdt", "skyline.porder_3.sfwd.rdt", "Substitue Forward: matrix->Substitute_Forward()."),
	("sbck", "-sbck_rdt", "skyline.porder_3.sbck.rdt", "Substitute Backward: matrix->Substitute_Backard().")
]

def short_description() : return "skyline-decompose_cholesky -- cube1.txt -- polinomial order 3"
...
def setup_cmd():
	...
	# Check run directory
	rundir = os.path.join(builddir,'scripts','skyline_tst02')
