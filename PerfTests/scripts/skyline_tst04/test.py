...
rdtfiles_l = [
	...
	("ldlt", "-ldlt_rdt", "skyline.porder_2.ldlt.rdt", "LDLt Decomposition: matrix->Decompose_LDLt(). Decompose matrix using LDLt Decomposition.")
]

def short_description() : return "skyline-decompose_ldlt -- cube1.txt -- polinomial order 2"
...
def setup_cmd():
	...
	# Check run directory
	rundir = os.path.join(builddir,'scripts','skyline_tst04')
