...
rdtfiles_l = [
	...
	("sor", "-sor_rdt", "skyline.porder_3.sor.rdt", "SolveSOR: matrix->SolveSOR(...). Solve a linear system using successive over-relaxation method.")
]

def short_description() : return "skyline-solveSOR -- cube1.txt -- polinomial order 3"
