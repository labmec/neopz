...
sorfn=("sor", "-sor_rdt", "skyline.porder_3.sor.rdt", "SolveSOR: matrix->SolveSOR(...). Solve a linear system using successive over-relaxation method.")
...
description="skyline-solveSOR -- cube1.txt -- polinomial order 3"
