...
rdtfiles_l = [
	...
	("sor", "-sor_rdt", "skyline.porder_6.sor.rdt", "SolveSOR: matrix->SolveSOR(...). Solve a linear system using successive over-relaxation method.")
]

def short_description() : return "skyline-solveSOR -- cube1.txt -- polinomial order 6"
...
def setup_cmd():
	...
	# Check run directory
	rundir = os.path.join(builddir,'scripts','skyline_tst11')
