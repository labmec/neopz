...
sorfn=("sor", "-sor_rdt", "skyline.porder_6.sor.rdt", "SolveSOR: matrix->SolveSOR(...). Solve a linear system using successive over-relaxation method.")
...
description="skyline-solveSOR -- cube1.txt -- polinomial order 6"
