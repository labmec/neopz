...
rdtfiles_l = [
	...
	("sor", "-sor_rdt", "sor.rdt", "SolveSOR: matrix->SolveSOR(...). Solve a linear system using successive over-relaxation method.")
]

def short_description() : return "skyline tests (SolveSOR) -- cube1.txt -- polinomial order 6"
