...
rdtfiles_l = [
	...
	("clk", "-clk_rdt", "skyline.porder_4.clk.rdt", "Cholesky Decomposition: matrix->Decompose_Cholesky(). Decompose matrix using Cholesky Decomposition.")
]

def short_description() : return "skyline-decompose_cholesky -- cube1.txt -- polinomial order 4"
