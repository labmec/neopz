...
rdtfiles_l = [
	...
	("mult", "-mult_rdt", "skyline.porder_3.mult.rdt", "MultAdd: matrix->MultAdd(...). Multiply matrix by another matrix.")
]

def short_description() : return "skyline-multadd -- cube1.txt -- polinomial order 3"
