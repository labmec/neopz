...
ldltfn=("ldlt", "-ldlt_rdt", "skyline.porder_3.ldlt.rdt", "LDLt Decomposition: matrix->Decompose_LDLt(). Decompose matrix using LDLt Decomposition.")
...
description="skyline-decompose_ldlt -- cube1.txt -- polinomial order 3"
