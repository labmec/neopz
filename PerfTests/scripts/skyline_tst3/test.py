...
multfn=("mult", "-mult_rdt", "skyline.porder_3.mult.rdt", "MultAdd: matrix->MultAdd(...). Multiply matrix by another matrix.")
...
def setup_cmd():
	...
	# Check run directory
	rundir = os.path.join(builddir,'scripts','skyline_tst3')
...
description="skyline-multadd -- cube1.txt -- polinomial order 3"
