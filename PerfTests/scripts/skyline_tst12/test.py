...
def short_description() : return "skyline tests -- cube1.txt -- polinomial order 5"
...
limits = { "cpu"   : (resource.RLIMIT_CPU,  10000, "Max CPU user time in seconds (not wall clock time)"), 
