...
function run_cfg
{
    ...
    GOLDEN="/Users/borin/Desktop/neopz/neopz_trunk/PerfTests/neopz_perf_data/SubStruct/outputs/$OF"
    MD5F="/Users/borin/Desktop/neopz/neopz_trunk/PerfTests/neopz_perf_data/SubStruct/outputs/$OF.md5"

    ASSRDT="$BASEOUT.ass.rdt"
    CRERDT="$BASEOUT.cre.rdt"

    CMD="$APP -bc -cf1 /Users/borin/Desktop/neopz/neopz_trunk/PerfTests/neopz_perf_data/SubStruct/inputs/$IF -dc3 $OF -st3 -ass_rdt $ASSRDT -cre_rdt $CRERDT" 
...
# ==================================
APP="/Users/borin/Desktop/neopz/neopz_trunk_build/PerfTests/SubStruct/Perf-SubStruct"
