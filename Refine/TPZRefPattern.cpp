...
TPZRefPattern::TPZRefPattern() : fId(nonInitializedId), fName("noname"), fSideRefPattern(0)
{
	
}

TPZRefPattern::TPZRefPattern(std::istream &file) : fId(nonInitializedId), fName("noname"), fSideRefPattern(0)
{
	ImportPattern(file);	
}

TPZRefPattern::TPZRefPattern(const std::string &file ) : fId(nonInitializedId), fName("noname"), fSideRefPattern(0)
{
...
TPZRefPattern::TPZRefPattern(TPZGeoMesh &RefPatternMesh): fRefPatternMesh(RefPatternMesh), fId(nonInitializedId), fName("noname"), fSideRefPattern(0)
{
...
{
	#ifdef DEBUG
	if( pos >= fPermutedRefPatterns.size() )
	{
