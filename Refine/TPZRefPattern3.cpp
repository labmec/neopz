...
// TPZRefPattern3::TPZRefPattern3() : fSideRefPattern(0), fId(nonInitializedId), fName("noname")
// {
...
// TPZRefPattern3::TPZRefPattern3(TPZGeoMesh &RefPatternMesh): fRefPatternMesh(RefPatternMesh), fSideRefPattern(0), fId(nonInitializedId), fName("noname")
// {
...
// TPZRefPattern3::TPZRefPattern3(const TPZRefPattern3 &copy) : fRefPatternMesh(copy.fRefPatternMesh), fSideRefPattern(copy.fSideRefPattern), fId(nonInitializedId), fName("noname")
// {
// 	fName = copy.fName;
...
// int TPZRefPattern3::operator==(const TPZAutoPointer<TPZRefPattern3> compare) const
// {
...
// {
// 	fName = TPZRefPattern3Tools::BuildRefPatternModelName(*this);
// }

// void TPZRefPattern3::Read(TPZStream& buf, void* context) { //ok
...
// void TPZRefPattern3::Write(TPZStream& buf, int withclassid) const { //ok
...
// int TPZRefPattern3::FatherSide(int side, int sub)
// {
// 	int nsides = fRefPatternMesh.ElementVec()[sub+1]->NSides();
// 	int nsubs = NSubElements();
// 	if(side<0 || side>nsides ||  sub <0 ||  sub >nsubs)
// 	{
// 		PZError << "TPZRefPattern3::FatherSide arguments wrong argument\n";
...
// void TPZRefPattern3::SideSubElement(int sidein, int position, int & sub, int & sideout)
// {
// 	if(sidein<0 || sidein>Element(0)->NSides())
// 	{
// 		PZError << "TPZRefPattern3::SideSubElement null side, side = " << sidein << endl;
// 	}
...
// 	{
// 		PZError << "TPZRefPattern3::SideSubElement wrong position, position = " << position << endl;
// 		sub = sideout = -1;
// 		return;
// 	}
...
// TPZTransform<> TPZRefPattern3::Transform(int side, int sub)
// {
// 	int nsides = Element(sub+1)->NSides();
// 	int nsubs = NSubElements();
// 	if(side<0 || side>nsides ||  sub <0 ||  sub >nsubs){
// 		PZError << "TPZRefPattern3::Transform wrong arguments\n";
// 		PZError << "side = " << side << " sub = " << sub;
...
// void TPZRefPattern3::SideNodes(int side, TPZVec<int> &vecnodes)
// {
...
// 	{
// 		PZError << "TPZRefPattern3::SideNodes wrong side, side = " << side << endl;
// 		vecnodes.Resize(0);
// 		return;
// 	}
// 	if (side < nnod)
...
// 		if(!subs.Element())
// 		{
// 			PZError << "TPZRefPattern3::NSideSubElements puncture in the partition\n";
// 			vecnodes.Resize(0);
// 			return;
// 		}
...
// int TPZRefPattern3::NSideNodes(int side)
// {
// 	int nsdfat = Element(0)->NSides();
// 	if(side<0 || side>nsdfat)
// 	{
// 		PZError << "TPZRefPattern3::NSideNodes wrong side, side = " << side << endl;
// 		return -1;
// 	}
...
// int TPZRefPattern3::NNodes()
// {
// 	return ( fRefPatternMesh.NodeVec().NElements() );
// }

// int TPZRefPattern3::NSubElements()
// {
// 	return fNSubEl;
// }

// void TPZRefPattern3::NSideSubElements()
// {
...
// int TPZRefPattern3::NSideSubElements(int side)
// {
// 	if(side<0 || side>Element(0)->NSides()){
// 		PZError << "TPZRefPattern3::NSideSubElement null side, side = " << side << endl;
// 		return -1;/**danou-se*/
// 	}
...
// void TPZRefPattern3::MeshPrint()
// {
// 	ofstream out("meshrefpatt.out");
// 	cout << "\nTPZRefPattern3::Print imprime a malha do padrao de refinamento, arquivo de saida: meshrefpatt.out\n";
// 	fRefPatternMesh.Print(out);
// 	out.flush();
// 	out.close();
// }

// void TPZRefPattern3::PrintMore(std::ostream &out)
// {
// 	out << "TPZRefPattern3::TPZSideTransform::Print lado do pai associados aos lados dos sub-elementos\n\n";
// 	int iside,isub;
...
// void TPZRefPattern3::Print(std::ostream &out)
// {
...
// void TPZRefPattern3::ShortPrint(std::ostream &out)
// {
...
// int TPZRefPattern3::SizeOfSubsSides(int ison)
// {
// 	int nsubs = NSubElements();
// 	if(ison==nsubs) ison--;
// 	if(ison < 0 || ison > nsubs-1){
// 		PZError <<  "TPZRefPattern3::SizeOfSubsSides filho nao existe, filho = " << ison << endl;
//         DebugStop();
//     }
// 	int count = 0,isub;
// 	for(isub=0;isub<nsubs;isub++){
...
// void TPZRefPattern3::DefinitionOfSizePartition()
// {
...
// 	//  cout << "\nTPZRefPattern3::DefinitionOfSizePartition arquivo da particao: dimofpartition.out\n";
// }

// int TPZRefPattern3::IsFatherNeighbour(TPZGeoElSide fathside, TPZGeoEl *son)
// {
...
// 	if(iel<0 || iel>nel){
// 		PZError <<  "TPZRefPattern3::Element elemento nao existe, elemento de id = " << iel << endl;
// 	}
// 	return ( fRefPatternMesh.ElementVec()[iel]  );
// }

// int TPZRefPattern3::IsNotEqual(TPZTransform<> &Told, TPZTransform<> &Tnew)
// {
...
// TPZAutoPointer<TPZRefPattern3> TPZRefPattern3::SideRefPattern(int side)
// {
...
// TPZAutoPointer<TPZRefPattern3> TPZRefPattern3::SideRefPattern(int side, TPZTransform<> &trans)
// {
// 	if(side >= fSideRefPattern.NElements())
// 	{
// 		return NULL;
// 	}
// 	TPZAutoPointer<TPZRefPattern3> sideref = this->SideRefPattern(side);
// 	TPZAutoPointer<TPZRefPattern3> zero;
// 	if(!sideref)
// 	{
// 		return zero;
// 	}
...
// void TPZRefPattern3::CreateNewNodes(TPZGeoEl * gel, TPZVec<int64_t> &newnodeindexes)
// {
// 	int side;
...
// void TPZRefPattern3::CreateMidSideNodes(TPZGeoEl * gel, int side, TPZVec<int64_t> &newnodeindexes)
// {
// 	int i, j, k;
// 	int64_t index;
...
// 		TPZAutoPointer<TPZRefPattern3> found = gRefDBase.FindRefPattern(refp);
...
// 		TPZAutoPointer<TPZRefPattern3> found = gRefDBase.FindRefPattern(sideref);
...
// TPZAutoPointer<TPZRefPattern3> TPZRefPattern3::FindRefPattern(TPZTransform<> &trans)
// {
// 	REAL tol = 1.e-6;
...
// 	std::list<TPZRefPattern3Permute> &permlist = fPermutations[type];
// 	std::list<TPZRefPattern3Permute>::iterator it;
// 	for(it = permlist.begin(); it != permlist.end(); it++)
// 	{
// 		TPZRefPattern3Permute &tmp = (*it);
// 		if(!tmp.fTransform.CompareTransform(trans, tol))
// 		{
// 			TPZAutoPointer<TPZRefPattern3> refpPerm = new TPZRefPattern3(*this, tmp.fPermute);
// 			TPZAutoPointer<TPZRefPattern3> found = gRefDBase.FindRefPattern(refpPerm);
...
// TPZAutoPointer<TPZRefPattern3> TPZRefPattern3::GetPermutation(int pos)
// {
// #ifdef PZDEBUG
...
//  	TPZAutoPointer<TPZRefPattern3> refp = gRefDBase.FindRefPattern(id);
...
// void TPZRefPattern3::ImportPattern(std::istream &in)
// {
// 	int nnodes, nelems;
// 	in >> nnodes >> nelems;
// 	in >> fId >> fName;
...
// void TPZRefPattern3::ExportPattern(std::ostream &out)
// {
...
// void TPZRefPattern3::ReadPattern(std::istream &in)
// {
//     int nnodes, nelems;
// 	in >> nnodes >> nelems;
// 	in >> fId >> fName;
...
// #ifdef PZDEBUG
// 	//TPZRefPattern3Tools::TransformationTest(this);
// #endif
// }

// void TPZRefPattern3::WritePattern(std::ofstream &out)
// {
// 	ExportPattern(out);
...
// 			{
// 				PZError << "TPZRefPattern3::ComputePartition erro de dimensionamento\n";
// 			}
...
// 		{
// 			PZError << "TPZRefPattern3::ComputePartition particao inaonsistente";
// 		}
// 	}
...
// void TPZRefPattern3::TPZPartitionFatherSides::Print(TPZGeoMesh &gmesh,std::ostream &out)
// {
// 	out << "TPZRefPattern3::TPZSideTransform::Print partic dos lados do pai pelos lados dos sub-elementos\n\n";
...
// int TPZRefPattern3::TPZPartitionFatherSides::ClassId() const {
//     return Hash("TPZRefPattern3::TPZPartitionFatherSides");
// }

// void TPZRefPattern3::TPZPartitionFatherSides::Read(TPZStream& buf, void* context) { //ok
//     buf.Read(fInitSide);
//     buf.Read(fPartitionSubSide);
//     buf.Read(fNSubSideFather);
// }

// void TPZRefPattern3::TPZPartitionFatherSides::Write(TPZStream& buf, int withclassid) const { //ok
//     buf.Write(fInitSide);
...
// int TPZRefPattern3::TPZSideTransform::ClassId() const {
//     return Hash("TPZRefPattern3::TPZSideTransform");
// }

// void TPZRefPattern3::TPZSideTransform::Read(TPZStream& buf, void* context) { //ok
//     buf.Read(fInitSonSides);
//     buf.Read(fFatherSide);
//     buf.Read(fSideTransform);
// }

// void TPZRefPattern3::TPZSideTransform::Write(TPZStream& buf, int withclassid) const { //ok
//     buf.Write(fInitSonSides);
//     buf.Write(fFatherSide);
//     buf.Write(fSideTransform);
// }

// void TPZRefPattern3::TPZSideTransform::Print(TPZGeoMesh &gmesh, std::ostream &out)
// {
// 	out << "TPZRefPattern3::TPZSideTransform::Print transformacoes parametricas\n\n";
...
// void TPZRefPattern3::PrintVTK(std::ofstream &file, bool matColor)
// {
// 	//	TPZGeoMesh * gmesh = &(RefPatternMesh());
// 	//	TPZRefPattern3Tools::PrintGMeshVTK(gmesh, file, matColor);
...
// void TPZRefPattern3::GeneratePermutations(TPZGeoEl *gel)
// {
// 	if (!gel)
// 	{
...
// MElementType TPZRefPattern3::Type()
// {
