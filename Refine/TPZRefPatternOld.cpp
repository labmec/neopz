///**
// * @file
// * @brief Contains the implementation of the TPZRefPatternOld methods.
// */
///* Generated by Together */
//
//#include "TPZRefPatternOld.h"
...
//
//#ifdef LOG4CXX
//static LoggerPtr logger(Logger::getLogger("pz.mesh.TPZRefPatternOld"));
//#endif
//
//std::map<MElementType, std::list<TPZRefPatternOld::TPZRefPatternOldPermute> > TPZRefPatternOld::fPermutations;
//
//TPZRefPatternOld::TPZRefPatternOld() : fSideRefPattern(0), fId(nonInitializedId), fName("noname")
//{
//
//}
//
//TPZRefPatternOld::TPZRefPatternOld(std::istream &file) : fSideRefPattern(0), fId(nonInitializedId), fName("noname")
//{
//	ImportPattern(file);
//}
//
//TPZRefPatternOld::TPZRefPatternOld(const std::string &file ) : fSideRefPattern(0), fId(nonInitializedId), fName("noname")
//{
...
//}
//
//TPZRefPatternOld::TPZRefPatternOld(TPZGeoMesh &RefPatternMesh): fRefPatternMesh(RefPatternMesh), fSideRefPattern(0), fId(nonInitializedId), fName("noname")
//{
...
//}
//
//TPZRefPatternOld::TPZRefPatternOld(const TPZRefPatternOld &copy) : fRefPatternMesh(copy.fRefPatternMesh), fSideRefPattern(copy.fSideRefPattern), fId(nonInitializedId), fName("noname")
//{
//	fName = copy.fName;
...
//}
//
//TPZRefPatternOld::TPZRefPatternOld(const TPZRefPatternOld &copy, const TPZPermutation &permute) : fRefPatternMesh(copy.fRefPatternMesh), fId(nonInitializedId), fName("noname")
//{
//	fNSubEl = copy.fNSubEl;
...
//}
//
//int TPZRefPatternOld::operator==(const TPZAutoPointer<TPZRefPatternOld> compare) const
//{
...
// */
//TPZRefPatternOld::~TPZRefPatternOld()
//{
...
//
//
//void TPZRefPatternOld::BuildName()
//{
//	fName = TPZRefPatternOldTools::BuildRefPatternModelName(*this);
//}
//
//int TPZRefPatternOld::ClassId() const {
//    return Hash("TPZRefPatternOld");
//}
//
//void TPZRefPatternOld::Read(TPZStream& buf, void* context) { //ok
...
//}
//
//void TPZRefPatternOld::Write(TPZStream& buf, int withclassid) const { //ok
...
//}
//
//void TPZRefPatternOld::SideSubElement(int sidein, int position, int & sub, int & sideout)
//{
//	if(sidein<0 || sidein>Element(0)->NSides())
//	{
//		PZError << "TPZRefPatternOld::SideSubElement null side, side = " << sidein << endl;
//	}
...
//	{
//		PZError << "TPZRefPatternOld::SideSubElement wrong position, position = " << position << endl;
//		sub = sideout = -1;
//		return;
//	}
...
//}
//
//TPZTransform<> TPZRefPatternOld::Transform(int side, int sub)
//{
//	int nsides = Element(sub+1)->NSides();
//	int nsubs = NSubElements();
//	if(side<0 || side>nsides ||  sub <0 ||  sub >nsubs){
//		PZError << "TPZRefPatternOld::Transform wrong arguments\n";
//		PZError << "side = " << side << " sub = " << sub;
...
//}
//
//void TPZRefPatternOld::SideNodes(int side, TPZVec<int> &vecnodes)
//{
...
//	{
//		PZError << "TPZRefPatternOld::SideNodes wrong side, side = " << side << endl;
//		vecnodes.Resize(0);
//		return;
//	}
//	if (side < nnod)
...
//		if(!subs.Element())
//		{
//			PZError << "TPZRefPatternOld::NSideSubElements puncture in the partition\n";
//			vecnodes.Resize(0);
//			return;
//		}
...
//}
//
//int TPZRefPatternOld::NSideNodes(int side)
//{
//	int nsdfat = Element(0)->NSides();
//	if(side<0 || side>nsdfat)
//	{
//		PZError << "TPZRefPatternOld::NSideNodes wrong side, side = " << side << endl;
//		return -1;
//	}
...
//}
//
//int TPZRefPatternOld::NNodes()
//{
//	return ( fRefPatternMesh.NodeVec().NElements() );
//}
//
//int TPZRefPatternOld::NSubElements()
//{
//	return fNSubEl;
//}
//
//void TPZRefPatternOld::NSideSubElements()
//{
...
//}
//
//int TPZRefPatternOld::NSideSubElements(int side)
//{
//	if(side<0 || side>Element(0)->NSides()){
//		PZError << "TPZRefPatternOld::NSideSubElement null side, side = " << side << endl;
//		return -1;/**danou-se*/
//	}
...
//}
//
//void TPZRefPatternOld::MeshPrint()
//{
//	ofstream out("meshrefpatt.out");
//	cout << "\nTPZRefPatternOld::Print imprime a malha do padrao de refinamento, arquivo de saida: meshrefpatt.out\n";
//	fRefPatternMesh.Print(out);
//	out.flush();
//	out.close();
//}
//
//void TPZRefPatternOld::PrintMore(std::ostream &out)
//{
//	out << "TPZRefPatternOld::TPZSideTransform::Print lado do pai associados aos lados dos sub-elementos\n\n";
//	int iside,isub;
...
//}
//
//void TPZRefPatternOld::Print(std::ostream &out)
//{
//
//#ifdef LOG4CXX
...
//}
//
//void TPZRefPatternOld::ShortPrint(std::ostream &out)
//{
...
//}
//
//int TPZRefPatternOld::SizeOfSubsSides(int ison)
//{
//	int nsubs = NSubElements();
//	if(ison==nsubs) ison--;
//	if(ison < 0 || ison > nsubs-1){
//		PZError <<  "TPZRefPatternOld::SizeOfSubsSides filho nao existe, filho = " << ison << endl;
//        DebugStop();
//    }
//	int count = 0,isub;
//	for(isub=0;isub<nsubs;isub++){
...
//}
//
//void TPZRefPatternOld::DefinitionOfSizePartition()
//{
...
//	//  cout << "\nTPZRefPatternOld::DefinitionOfSizePartition arquivo da particao: dimofpartition.out\n";
//}
//
//int TPZRefPatternOld::IsFatherNeighbour(TPZGeoElSide fathside, TPZGeoEl *son)
//{
...
//}
//
//TPZGeoEl *TPZRefPatternOld::Element(int iel)
//{
//	int nel = NSubElements()+1;/**filhos mais o pai*/
//	if(iel<0 || iel>nel){
//		PZError <<  "TPZRefPatternOld::Element elemento nao existe, elemento de id = " << iel << endl;
//	}
//	return ( fRefPatternMesh.ElementVec()[iel]  );
//}
//
//int TPZRefPatternOld::IsNotEqual(TPZTransform<> &Told, TPZTransform<> &Tnew)
//{
...
//}
//
//TPZAutoPointer<TPZRefPatternOld> TPZRefPatternOld::SideRefPattern(int side)
//{
...
//}
//
//TPZAutoPointer<TPZRefPatternOld> TPZRefPatternOld::SideRefPattern(int side, TPZTransform<> &trans)
//{
//	if(side >= fSideRefPattern.NElements())
//	{
//		return NULL;
//	}
//	TPZAutoPointer<TPZRefPatternOld> sideref = this->SideRefPattern(side);
//	TPZAutoPointer<TPZRefPatternOld> zero;
//	if(!sideref)
//	{
//		return zero;
//	}
...
//}
//
//void TPZRefPatternOld::CreateNewNodes(TPZGeoEl * gel, TPZVec<int64_t> &newnodeindexes)
//{
//	int side;
...
//}
//
//void TPZRefPatternOld::CreateMidSideNodes(TPZGeoEl * gel, int side, TPZVec<int64_t> &newnodeindexes)
//{
//	int i, j, k;
//	int64_t index;
...
//}
//
//string TPZRefPatternOld::Name()
//{
//	return fName;
//}
//
//void TPZRefPatternOld::InsertPermuted()
//{
...
//
//	std::list<TPZRefPatternOldPermute> &permlist = fPermutations[geltype];
//	std::list<TPZRefPatternOldPermute>::iterator it;
//	fPermutedRefPatterns.resize(permlist.size());
//
//	int64_t counter;
//	for(it=permlist.begin(), counter=0; it != permlist.end(); it++,counter++)
//	{
//		TPZAutoPointer<TPZRefPatternOld> refp(new TPZRefPatternOld(*this,(*it).fPermute));
//		TPZAutoPointer<TPZRefPatternOld> found = gRefDBase.FindRefPattern(refp);
//
//#ifdef LOG4CXX
...
//}
//
//void TPZRefPatternOld::GenerateSideRefPatterns()
//{
...
//			continue;
//		}
//		TPZAutoPointer<TPZRefPatternOld> sideref(new TPZRefPatternOld());
//
...
//
//		TPZAutoPointer<TPZRefPatternOld> found = gRefDBase.FindRefPattern(sideref);
//
//		if(!found.operator ->())
//		{
//			if(this->NameInitialized())
...
//}
//
//TPZAutoPointer<TPZRefPatternOld> TPZRefPatternOld::FindRefPattern(TPZTransform<> &trans)
//{
//	REAL tol = 1.e-6;
...
//
//	std::list<TPZRefPatternOldPermute> &permlist = fPermutations[type];
//	std::list<TPZRefPatternOldPermute>::iterator it;
//	for(it = permlist.begin(); it != permlist.end(); it++)
//	{
//		TPZRefPatternOldPermute &tmp = (*it);
//		if(!tmp.fTransform.CompareTransform(trans, tol))
//		{
//			TPZAutoPointer<TPZRefPatternOld> refpPerm = new TPZRefPatternOld(*this, tmp.fPermute);
//			TPZAutoPointer<TPZRefPatternOld> found = gRefDBase.FindRefPattern(refpPerm);
//
//			return found;
//		}
//	}
...
//}
//
//void TPZRefPatternOld::InternalNodesIndexes(int side, TPZVec<TPZGeoElSideIndex> &nodeIndexes)
//{
...
//}
//
//void TPZRefPatternOld::InternalSidesIndexes(int side, TPZVec<TPZGeoElSideIndex> &sideIndexes)
//{
//	TPZVec<TPZGeoElSide> gelvec;
//	int nSubEl = SidePartition(gelvec, side);
...
//}
//
//TPZAutoPointer<TPZRefPatternOld> TPZRefPatternOld::GetPermutation(int pos)
//{
//#ifdef PZDEBUG
...
// 	TPZAutoPointer<TPZRefPatternOld> refp = gRefDBase.FindRefPattern(id);
//
//	return refp;
//}
//
////private
//
//void TPZRefPatternOld::ImportPattern(std::istream &in)
//{
//	int nnodes, nelems;
//	in >> nnodes >> nelems;
//	in >> fId >> fName;
...
//}
//
//void TPZRefPatternOld::ExportPattern(std::ostream &out)
//{
...
//}
//
//void TPZRefPatternOld::ReadPattern(std::istream &in)
//{
//    int nnodes, nelems;
//	in >> nnodes >> nelems;
//	in >> fId >> fName;
...
//
//#ifdef PZDEBUG
//	//TPZRefPatternOldTools::TransformationTest(this);
//#endif
//}
//
//void TPZRefPatternOld::WritePattern(std::ofstream &out)
//{
//	ExportPattern(out);
//
...
//}
//
//int TPZRefPatternOld::SidePartition(TPZVec<TPZGeoElSide> &gelvec, int side)
//{
...
//}
//
//void TPZRefPatternOld::SetRefPatternMeshToMasterDomain()
//{
...
//}
//
//void TPZRefPatternOld::ComputeTransforms()
//{
...
//	if(!fath)
//	{
//		PZError << "TPZRefPatternOld::ComputePartition Father not exists?!\n";
//		DebugStop();
//	}
//
...
//}
//
//void TPZRefPatternOld::ComputePartition()
//{
...
//			{
//				PZError << "TPZRefPatternOld::ComputePartition erro de dimensionamento\n";
//			}
...
//		{
//			PZError << "TPZRefPatternOld::ComputePartition particao inaonsistente";
//		}
//	}
//
...
//
//void TPZRefPatternOld::TPZPartitionFatherSides::Print(TPZGeoMesh &gmesh,std::ostream &out)
//{
//	out << "TPZRefPatternOld::TPZSideTransform::Print partic dos lados do pai pelos lados dos sub-elementos\n\n";
...
//}
//
//int TPZRefPatternOld::TPZPartitionFatherSides::ClassId() const {
//    return Hash("TPZRefPatternOld::TPZPartitionFatherSides");
//}
//
//void TPZRefPatternOld::TPZPartitionFatherSides::Read(TPZStream& buf, void* context) { //ok
//    buf.Read(fInitSide);
//    buf.Read(fPartitionSubSide);
//    buf.Read(fNSubSideFather);
//}
//
//void TPZRefPatternOld::TPZPartitionFatherSides::Write(TPZStream& buf, int withclassid) const { //ok
//    buf.Write(fInitSide);
...
//
//int TPZRefPatternOld::TPZSideTransform::ClassId() const {
//    return Hash("TPZRefPatternOld::TPZSideTransform");
//}
//
//void TPZRefPatternOld::TPZSideTransform::Read(TPZStream& buf, void* context) { //ok
//    buf.Read(fInitSonSides);
//    buf.Read(fFatherSide);
//    buf.Read(fSideTransform);
//}
//
//void TPZRefPatternOld::TPZSideTransform::Write(TPZStream& buf, int withclassid) const { //ok
//    buf.Write(fInitSonSides);
//    buf.Write(fFatherSide);
//    buf.Write(fSideTransform);
//}
//
//void TPZRefPatternOld::TPZSideTransform::Print(TPZGeoMesh &gmesh, std::ostream &out)
//{
//	out << "TPZRefPatternOld::TPZSideTransform::Print transformacoes parametricas\n\n";
...
//}
//
//void TPZRefPatternOld::PrintVTK(std::ofstream &file, bool matColor)
//{
//	//	TPZGeoMesh * gmesh = &(RefPatternMesh());
//	//	TPZRefPatternOldTools::PrintGMeshVTK(gmesh, file, matColor);
//
...
////protected
//
//void TPZRefPatternOld::GeneratePermutations(TPZGeoEl *gel)
//{
//	if (!gel)
//	{
...
//	TPZRefPatternOldPermute refpermute;
//
...
//		if(valid)
//		{
//			TPZRefPatternOldPermute candidate;
...
//}
//
//void TPZRefPatternOld::PermuteMesh(const TPZPermutation &permute)
//{
//	int in;
...
//}
//
//void TPZRefPatternOld::BuildSideMesh(int side, TPZGeoMesh &SideRefPatternMesh)
//{
//	if(!fRefPatternMesh.ElementVec().NElements())
//	{
//		return;
...
//}
//
//MElementType TPZRefPatternOld::Type()
//{
//	return fRefPatternMesh.ElementVec()[0]->Type();
//}
//
//int TPZRefPatternOld::TPZRefPatternOldPermute::ClassId() const {
//    return Hash("TPZRefPatternOld::TPZRefPatternOldPermute");
//}
//
//void TPZRefPatternOld::TPZRefPatternOldPermute::Read(TPZStream& buf, void* context) { //ok
//    fPermute.Read(buf, context);
//    fTransform.Read(buf, context);
//}
//
//void TPZRefPatternOld::TPZRefPatternOldPermute::Write(TPZStream& buf, int withclassid) const { //ok
