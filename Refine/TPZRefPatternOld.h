///**
// * @file
// * @brief Contains the TPZRefPatternOld class which defines the topology of the current refinement pattern to a mesh.
// */
//#ifndef PZREFPATTERNOLDH
//#define PZREFPATTERNOLDH
//
//#include "pzvec.h"
//#include "pzgmesh.h"
//#include <iostream>
...
// */
//class TPZRefPatternOld : public TPZSavable {
//
//public:
//
//	TPZRefPatternOld();
...
//     */
//	TPZRefPatternOld(std::istream &file);
//
//	TPZRefPatternOld(const std::string &file);
//
//	/**
//     * @brief Creates an TPZRefPatternOld from a given mesh
//     */
//    TPZRefPatternOld(TPZGeoMesh &RefPatternMesh);
//
//    /**
//	 * @brief Copy constructor
//	 */
//    TPZRefPatternOld(const TPZRefPatternOld &copy);
//
//    /**
//     * @brief Create a copy of the TPZRefPatternOld applying the permutation on the first element
//     */
//    TPZRefPatternOld(const TPZRefPatternOld &copy, const TPZPermutation &permute);
//
//    /**
...
//    ~TPZRefPatternOld();
//
//	int operator==(const TPZAutoPointer<TPZRefPatternOld> compare) const;
//
//	void BuildName();
//
...
//
//	TPZAutoPointer<TPZRefPatternOld> SideRefPattern(int side);
//
//    /**
//     * @brief Find the side refinement pattern corresponding to the parameter transformation
//     */
//    TPZAutoPointer<TPZRefPatternOld> SideRefPattern(int side, TPZTransform<> &trans);
//
//	/**
...
//     */
//	TPZAutoPointer<TPZRefPatternOld> FindRefPattern(TPZTransform<> &trans);
//
//	/**
...
//
//	TPZAutoPointer<TPZRefPatternOld> GetPermutation(int pos);
//
...
//	class TPZRefPatternOldPermute : public TPZSavable {
//            public:
...
//		TPZRefPatternOldPermute(): fPermute(0)
//		{}
//		/** @brief Copy constructor */
//		TPZRefPatternOldPermute(const TPZRefPatternOldPermute &copy) : fPermute(copy.fPermute), fTransform(copy.fTransform)
//		{
//		}
//		/** Assignment operator */
//		TPZRefPatternOldPermute &operator=(const TPZRefPatternOldPermute &copy)
//		{
...
//	 */
//	static std::map<MElementType, std::list<TPZRefPatternOldPermute> > fPermutations;
//
//	std::string fName;
//
//	friend class
//	TPZRefPatternOldDataBase;
//
//	friend class
//	TPZRefPatternOldTools;
//
//    friend class
//    TPZRefPatternOld3;
//};
