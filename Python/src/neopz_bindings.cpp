...
//CONTAINERS
    ...
    py::class_<pztopology::TPZLine>(m, "TPZLine")
        ...
        .def_static("TransformElementToSide", &pztopology::TPZLine::TransformElementToSide)
         ...
         //TODO: should use py::overload_cast<> for both methods below, but Fad<REAL> breaks for some reason not clear right now
         //      USING_FAD was checked and was ON
        .def_static("IsInParametricDomain", (bool (*) (const TPZVec<REAL>&, REAL)) &pztopology::TPZLine::IsInParametricDomain)
        //.def_static("IsInParametricDomain", (bool (*) (const TPZVec<Fad<REAL>>&, REAL) &pztopology::TPZLine::IsInParametricDomain)
