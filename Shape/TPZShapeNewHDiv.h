/**
 * @file
 * @brief Contains TPZShapeNewHDiv class which implements HDiv shape using HCurlNoGrads functions on the facet and HDiv standard interior functions
...
struct TPZShapeNewHDiv : public TPZShapeHDiv<TSHAPE>, TPZShapeHCurlNoGrads<TSHAPE>
{
    TPZShapeNewHDiv();
