...
#ifndef TPZHYBRIDMIXEDELASTICITYUP
#define TPZHYBRIDMIXEDELASTICITYUP

enum AnalysisType {EGeneral, EPlaneStrain, EPlaneStress};

class TPZHybridMixedElasticityUP : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>, TPZMatErrorCombinedSpaces<STATE>> {
...
public:
    /// Empty Constructor
    TPZHybridMixedElasticityUP();

    /// Creates a material object and inserts it in the vector of material pointers of the mesh
    TPZHybridMixedElasticityUP(int matID, int dimension, REAL young_modulus, REAL poisson, AnalysisType analysisType = AnalysisType::EGeneral, REAL thickness = 1.0);
