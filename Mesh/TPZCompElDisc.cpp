//$Id: TPZCompElDisc.cpp,v 1.62 2005-01-28 16:58:44 tiago Exp $
...
void TPZCompElDisc::CreateInterface(int side)
{
  ...
  if(size){
    //neste caso existem ambos: esquerdo e direito, this e list[0], e s� vizinhos
...
//Agora, a interface tem o material do elemento de menor dimens� (i.e. condicao de contorno)
...
//     }
  ...
  //aqui n� existe igual: s�pode existir lower 
