...
TPZMatrix<REAL> * TPZSBandStructMatrix::CreateAssemble(TPZFMatrix<REAL> &rhs,TPZAutoPointer<TPZGuiInterface> guiInterface){
...
TPZMatrix<REAL> * TPZSBandStructMatrix::Create(){
	...
	return new TPZSBMatrix<REAL>(neq,band);
}
