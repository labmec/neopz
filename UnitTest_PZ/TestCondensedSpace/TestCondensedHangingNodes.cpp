...
*/
template<class tshape>
void TestConstrainedSpace(const int &xdiv, const int &pOrder, SpaceType stype, bool applyconstr);
...
TEST_CASE("Constrained Space", "[constrained_space_test]") {
    ...
    TestConstrainedSpace<pzshape::TPZShapeTetra>(xdiv,pOrder,sType, applyconstraint);
    if(sType == EH1) {
        TestConstrainedSpace<pzshape::TPZShapePrism>(xdiv,pOrder,sType, applyconstraint);
//        TestConstrainedSpace<pzshape::TPZShapePiram>(xdiv,pOrder,sType, applyconstraint);
    }
    //NEEDS FIX
//    if(sType != EHCurl){TestConstrainedSpace<pzshape::TPZShapeCube>(xdiv, pOrder, sType, applyconstraint);}
    TestConstrainedSpace<pzshape::TPZShapeCube>(xdiv, pOrder, sType, applyconstraint);
...
template<class tshape>
void TestConstrainedSpace(const int &xdiv, const int &pOrder, SpaceType stype, bool applyconstraint){
    ...
    strmat.SetApplyConstraintInternal(applyconstraint);
