...
namespace threadTest
{
    ...
    static void AutoPointerStressTest();
    // task to be executed
    static void ThreadTask(TPZAutoPointer<TPZFMatrix<REAL>> object);
...
BOOST_AUTO_TEST_CASE(multithread_stress_test)
{
...
// stress test for autopointer
static void threadTest::AutoPointerStressTest()
{
...
static void threadTest::ThreadTask(TPZAutoPointer<TPZFMatrix<REAL>> object)
{
