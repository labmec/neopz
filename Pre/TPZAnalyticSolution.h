...
struct TLaplaceExample1 : public TPZAnalyticSolution
{
    ...
    enum EExactSol {ENone, EConst, EX, ESinSin, ECosCos,  EArcTan, EArcTanSingular, ESteepWave,ESteepWave2, ESinDist, E10SinSin,E2SinSin, ESinSinDirNonHom,ESinMark,ESinMark2,ESharpGaussian2D,ESteklovNonConst,ESteklovNonConst2,EGalvisNonConst,EBoundaryLayer,EBubble, EBubble2D,ESinCosCircle, EHarmonic, EHarmonic2,
