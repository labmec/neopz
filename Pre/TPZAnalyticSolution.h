...
struct TLaplaceExample1 : public TPZAnalyticSolution
{
    ...
    enum EExactSol {ENone, EConst, EX, ESinSin, ECosCos,  EArcTan, ESteepWave, EArcTanSingular,ESinDist, E10SinSin,E2SinSin, ESinSinDirNonHom,ESinMark,ESteklovNonConst,EGalvisNonConst,EBoundaryLayer,EBubble, EBubble2D,ESinCosCircle, EHarmonic, EHarmonic2,
