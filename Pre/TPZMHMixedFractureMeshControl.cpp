//
//  TPZMHMixedFractureMeshControl.cpp
//  PZ
//
...
#include "TPZMHMixedFractureMeshControl.h"
#include "TPZVecL2.h"
#include "pzbndcond.h"
...
/*
TPZMHMixedFractureMeshControl::TPZMHMixedFractureMeshControl(TPZAutoPointer<TPZGeoMesh> gmesh, std::set<int64_t> &coarseindices) : TPZMHMixedMeshControl(gmesh,coarseindices)
{
}
*/

TPZMHMixedFractureMeshControl::TPZMHMixedFractureMeshControl(TPZAutoPointer<TPZGeoMesh> gmesh, TPZVec<int64_t> &coarseindices) : TPZMHMixedMeshControl(gmesh,coarseindices)
{
}

TPZMHMixedFractureMeshControl::TPZMHMixedFractureMeshControl(TPZAutoPointer<TPZGeoMesh> gmesh) : TPZMHMixedMeshControl(gmesh)
{
}

TPZMHMixedFractureMeshControl::~TPZMHMixedFractureMeshControl()
{
...
// this method creates "continuous" flux spaces in each subdomain
// maybe we should create yet another hybrid hdiv mesh control...
void TPZMHMixedFractureMeshControl::CreateInternalFluxElements()
{
    ...
    int64_t firstElemInMHMDomain = 0;
...
void TPZMHMixedFractureMeshControl::BuildComputationalMesh(bool usersubstructure)
{
...
void TPZMHMixedFractureMeshControl::HybridizeSkeleton(int skeletonmatid, int pressurematid)
{
...
void TPZMHMixedFractureMeshControl::CreatePressureInterfaces()
{
...
void TPZMHMixedFractureMeshControl::CreatePressureMHMMesh()
{
...
void TPZMHMixedFractureMeshControl::CreateSkeleton()
{
...
bool TPZMHMixedFractureMeshControl::NeedsHDivWrapper(TPZGeoElSide gelside)
{
...
void TPZMHMixedFractureMeshControl::SplitFluxElementsAroundFractures()
{
    fGMesh->ResetReference();
    int meshdim = fGMesh->Dimension();
    // build a vector which for each geoel index points to the flux element
...
// at this point, only wrapper elements will be created if there is a neighbouring
// pressure element. I intend to change this, each H(div) element will have
// a wrap element, except for boundary conditions
void TPZMHMixedFractureMeshControl::CreateHDivWrappers()
{
    fGMesh->ResetReference();
    int meshdim = fGMesh->Dimension();
    // build a vector which for each geoel index points to the flux element
...
void TPZMHMixedFractureMeshControl::FindConnectedElements(TPZGeoElSide &pressureside, int domain, TPZVec<TPZCompElSide> &fluxconnected)
{
...
void TPZMHMixedFractureMeshControl::CreateMultiPhysicsInterfaceElements(int dim)
{
    int meshdim = fGMesh->Dimension();
...
void TPZMHMixedFractureMeshControl::GroupandCondenseElements()
{
...
void TPZMHMixedFractureMeshControl::GroupElements(TPZCompMesh *cmesh)
{
...
void TPZMHMixedFractureMeshControl::CreateLowerDimensionPressureElements()
{
    fGMesh->ResetReference();
...
void TPZMHMixedFractureMeshControl::CreateSkeletonAxialFluxes()
{
    fGMesh->ResetReference();
    // create a vector that points a geometric element index to a pressure computational element
    int64_t nel = fPressureFineMesh->NElements();
...
// initially we will create only HDiv elements associated with the coarse skeleton elements
void TPZMHMixedFractureMeshControl::CreateInternalAxialFluxes()
{
...
void TPZMHMixedFractureMeshControl::CreateAxialFluxElement(TPZInterpolatedElement *PressureElement, int gelfluxmatid)
{
...
void TPZMHMixedFractureMeshControl::InsertPeriferalMaterialObjects()
{
...
void TPZMHMixedFractureMeshControl::InsertPeriferalHdivMaterialObjects()
{
...
void TPZMHMixedFractureMeshControl::InsertPeriferalPressureMaterialObjects()
{
...
void TPZMHMixedFractureMeshControl::ApplyNeighbourBoundaryCondition(TPZGeoEl *gel)
{
...
void TPZMHMixedFractureMeshControl::AdjustBoundaryConditionsOfFractures()
{
    fGMesh->ResetReference();
...
void TPZMHMixedFractureMeshControl::CheckMeshConsistency()
{
...
void TPZMHMixedFractureMeshControl::PrintFriendly(std::ostream &out)
{
    int64_t nel = fCMesh->NElements();
    int meshdim = fGMesh->Dimension();
    for (int64_t el=0; el<nel; el++) {
