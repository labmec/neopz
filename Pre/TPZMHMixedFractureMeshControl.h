//
//  TPZMHMixedFractureMeshControl.hpp
//  PZ
//
...
#ifndef TPZMHMixedFractureMeshControl_hpp
#define TPZMHMixedFractureMeshControl_hpp
...
class TPZMHMixedFractureMeshControl : public TPZMHMixedMeshControl
{
...
public:
    ...
    TPZMHMixedFractureMeshControl() : TPZMHMixedMeshControl()
    {
    ...
    TPZMHMixedFractureMeshControl(TPZAutoPointer<TPZGeoMesh> gmesh, TPZVec<int64_t> &coarseindices);
    
    TPZMHMixedFractureMeshControl(TPZAutoPointer<TPZGeoMesh> gmesh);
    
    
    TPZMHMixedFractureMeshControl(const TPZMHMixedFractureMeshControl &copy) : TPZMHMixedMeshControl(copy), fHDivWrapperMatId(copy.fHDivWrapperMatId)
    {
    }
    
    virtual ~TPZMHMixedFractureMeshControl();
    
    TPZMHMixedFractureMeshControl &operator=(const TPZMHMixedFractureMeshControl &cp)
    {
...
#endif /* TPZMHMixedFractureMeshControl_hpp */
