 ...
 * @ingroup util
 *
 * @brief This class implements a simple vector storage scheme for a
 * templated class T.
 *
...
public:
	...
	/**
	 * @brief will copy the vector into the current vector. Will first
	...
	/**
	 * @brief access operator, will perform bounds checking unless the
