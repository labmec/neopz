...
public:
	...
	static void PrintGMeshVTK(TPZGeoMesh *gmesh, std::ofstream &file, bool matColor);
	 ...
	 */
	static void PrintGMeshVTKneighbour_material(TPZGeoMesh *gmesh, std::ofstream &file, int neighMaterial, bool matColor);
	 ...
	 */
	static void PrintGMeshVTKmy_material(TPZGeoMesh *gmesh, std::ofstream &file, std::set<int> myMaterial, bool matColor);
