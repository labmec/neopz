 ...
 */
/**
 * \section Symmetric quadrature rules (see [1])
 * 
 ...
 * Given a simplex \f$E\f$ with \f$n\f$ vertices \f${ v_1, ..., v_n}\f$, the \f$n+1\f$ barycentric coordinates \f$ (\ksi_1, ..., \ksi_(n+1)) \f$ of a point \f$P=(x,y,z)\f$
 * with respect to \f$E\f$ is determined by \f$P=\SUM_(i=1)\ksi_i v_i\f$ and \f$\Sum_(i=1)\ksi_i = 1 \f$.
