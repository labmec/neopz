...
#ifdef _AUTODIFF
template<> void TPZFileStream::WriteData<Fad <float> >(Fad <float>  *p, int howMany);
template<> void TPZFileStream::WriteData<Fad <double> >(Fad <double>  *p, int howMany);
template<> void TPZFileStream::WriteData<Fad<long double> >(Fad<long double>  *p, int howMany);
#endif
