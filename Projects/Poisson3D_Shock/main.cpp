...
void ApplyingStrategyHPAdaptiveBasedOnExactSphereSolutionBestForTriangles(TPZCompMesh *cmesh,TPZVec<REAL> &ervecbyel,REAL MaxErrorByElement,REAL &MinErrorByElement,int nref) {
