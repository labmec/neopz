...
int main(int argc, char *argv[])
{
    ...
    if (DarcyDomain) {
        ...
        Test1->Run(SpaceDiscontinuous, pOrder, nx, ny, hx, hy,visco,permeability,theta);
    }
...
//teste 1
// definition of f
void f_source1(const TPZVec<REAL> & x, TPZVec<STATE>& f, TPZFMatrix<STATE>& gradu);
// definition of sol analytic
...
TPZCompMesh *CMesh_m(TPZGeoMesh *gmesh, int pOrder)
{
   ...
   // BCond0->SetForcingFunction(sol_exact1,bc_inte_order);
    ...
    //BCond1->SetForcingFunction(sol_exact1,bc_inte_order);
    cmesh->InsertMaterialObject(BCond1); //Insere material na malha
    ...
    //BCond2->SetForcingFunction(sol_exact1,bc_inte_order);
    cmesh->InsertMaterialObject(BCond2); //Insere material na malha
    ...
    //BCond3->SetForcingFunction(sol_exact1,bc_inte_order);
    cmesh->InsertMaterialObject(BCond3); //Insere material na malha
