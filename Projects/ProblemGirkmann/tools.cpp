...
//para hidrostatica
//const int mat2BaseBCDois = -8; //Contorno da Base do anel/Reacao de apoio
//const int mat1Juncao = -9; 
...
//	
//	TPZFMatrix v(3,1,0.), vl(3,1,0.), vltemp(3,1,0.);
//	v(0,0) = 0.;
//	v(1,0) = 1.;
//	
...
//			new TPZGeoElRefPattern< TPZGeoBlend< TPZGeoQuad > > (id,TopolQuad,mat1Id,*gmesh);
//			id++;
//			
//			TopolQuad[0] += 1;	
//			TopolQuad[1] += 1;
...
//			TPZGeoEl * gel = new TPZGeoElRefPattern< TPZArc3D > (id,TopolArc,mat1ArcGeoUm,*gmesh);
//			id++;
//			TopolArc[0] += 1;
//			TopolArc[1] += 1;
//			TopolArc[2] += 1;
//			new TPZGeoElRefPattern< TPZArc3D > (id,TopolArc,mat1ArcBC,*gmesh);
//			id++;
//			
//			TopolArc[0] += 1;
//			TopolArc[1] += 1;
//			TopolArc[2] += 1;
//			new TPZGeoElRefPattern< TPZArc3D > (id,TopolArc,mat1ArcGeoDois,*gmesh);
//			id++;			 
//		}
//		
//		//---------------------
//		TopolLine[0] = 0;
//		TopolLine[1] = 1;
//		new TPZGeoElRefPattern< TPZGeoLinear > (id,TopolLine,mat1EngBC,*gmesh);
//		id++;
//		
//		TopolLine[0] = 1;
//		TopolLine[1] = 2;
...
//		
//		TopolPoint[0] = 0;
//		new TPZGeoElRefPattern< TPZGeoPoint> (id,TopolPoint,mat1EngPoint1, *gmesh);
//		id++;
//		
//		TopolPoint[0] = 2;
//		new TPZGeoElRefPattern< TPZGeoPoint> (id,TopolPoint,mat1EngPoint2, *gmesh);
//		id++;
//		
...
//		new TPZGeoElRefPattern< TPZGeoQuad > (id,TopolQuad,mat2Id,*gmesh);
//		id++;
//		
...
//		new TPZGeoElRefPattern< TPZGeoLinear > (id,TopolLine,mat2BaseBC, *gmesh);
//		id++;
//		
//		TopolPoint[0] = Qnodes-3;
//		new TPZGeoElRefPattern< TPZGeoPoint> (id,TopolPoint,mat2BaseBCPoint, *gmesh);
//		id++;
//		
//		//--------------------------- Refinamento Direcional ---------------------------------
//		TopolPoint[0] = Qnodes - 6;
//		new TPZGeoElRefPattern< TPZGeoPoint > (id,TopolPoint,matPointRefDir1,*gmesh);
//		id++;
//		
//		TopolPoint[0] = Qnodes - 4;
//		new TPZGeoElRefPattern< TPZGeoPoint > (id,TopolPoint,matPointRefDir2,*gmesh);
//		id++;
//		
//		TopolLine[0] = Qnodes - 6;
//		TopolLine[1] = Qnodes - 5;
//		new TPZGeoElRefPattern< TPZGeoLinear > (id,TopolLine,matRefDir1,*gmesh);
//		id++;
//		
...
//			 vtkname << "Girk/DebugGirk" << meshcount<<".vtk";
//			 ofstream output(vtkname.str().c_str());
//			 TPZRefPatternTools::PrintGMeshVTK(gmesh,output);
//			 meshcount++;
//			 }
//			 */			
//			int nel = gmesh->NElements();
...
//			 {	
//			 TPZVec<REAL> qsi(1,0.);
//			 TPZManVector<REAL, 3> x(3,0.), xnode(3,0.);
//			 gel->X(qsi, x);
//			 gmesh->NodeVec()[TopolArc[2]].GetCoordinates(xnode);
//			 gel->Print(cout);
//			 cout << x << endl;
//			 cout << xnode << endl;
//			 cout << "====================\n";
...
//		TPZFMatrix k1(2,2,0.), k2(2,2,0.), f(2,1,0.);
//		k1(1,1) = 1.e-3;
...
//		TPZFMatrix Reac1(2,2,0.), Reac2(2,1,0.);
...
//		TPZFMatrix Reac12(2,2,0.), Reac22(2,1,0.);
...
//					TPZIntPoints *intr = gel->CreateSideIntegrationRule(gel->NSides()-1,10/*20*/);
...
// */
//void tools::TesteInterface(TPZCompMesh *cmesh, TPZFMatrix &solution)
//{
