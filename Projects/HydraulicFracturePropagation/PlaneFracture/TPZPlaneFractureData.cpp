...
//}
//
//void Input3DDataStruct::SetData(int NStripes, REAL Visc, REAL SigN, REAL QinjTot, REAL Ttot, REAL maxDeltaT, int nTimes,
...
//    REAL Hbullet = 1.;//AQUICAJU
//    REAL QinjSecao = Qinj1asa / Hbullet;
//    fQinj = QinjSecao;
//    
//    fTtot = Ttot;
//    factTime = fminDeltaT;
