...
void TRMRawData::SinglePhaseReservoir_Ae(bool Is3DGeometryQ){
    ...
    fReduceBasisQ.second.second.Push(5); // x
    ...
    fIntial_bc_data.Push(W);
    W[0] = std::make_pair(0,new TPZDummyFunction<REAL>(Pressure_Ae));
    fRecurrent_bc_data.Push(W);
    
    fGammaIds.Push(bc_E);
    E[0] = std::make_pair(2,new TPZDummyFunction<REAL>(Impervious));
    fIntial_bc_data.Push(E);
    E[0] = std::make_pair(0,new TPZDummyFunction<REAL>(Pressure_Ae));
    fRecurrent_bc_data.Push(E);
    ...
    fIntial_bc_data.Push(WPro);
    WPro[0] = std::make_pair(0,new TPZDummyFunction<REAL>(Pressure_Ae));
    fRecurrent_bc_data.Push(WPro);
    ...
    fIntial_bc_data.Push(WInj);
    WInj[0] = std::make_pair(0,new TPZDummyFunction<REAL>(Pressure_Ae));
    fRecurrent_bc_data.Push(WInj);
    
    
}
void TRMRawData::Pressure_Ae(const TPZVec< REAL >& pt, REAL time, TPZVec< REAL >& P, TPZFMatrix< REAL >& GradP){
    REAL p = 1.0e6;
    P[0] = p;
    return;
}
...
//    fReportingTimes.Push(std::make_pair(25.0*day,true));
    ...
    fReduceBasisQ.second.second.Push(5); // z
...
//    fRecurrent_bc_data.Push(E);
    ...
    fGammaIds.Push(bc_N);
    N[0] = std::make_pair(0,new TPZDummyFunction<REAL>(PressureOutlet_2p));
    fIntial_bc_data.Push(N);
    N[0] = std::make_pair(0,new TPZDummyFunction<REAL>(PressureOutlet_2p));
    fRecurrent_bc_data.Push(N);
...
void TRMRawData::ThreePhaseWaterOilGasReservoir(bool Is3DGeometryQ){
...
//    }
    ...
    REAL s = 1.0;
//    fReportingTimes.Push(std::make_pair(s*2000.0*day,true));
//    fReportingTimes.Push(std::make_pair(s*1800.0*day,false));
//    fReportingTimes.Push(std::make_pair(s*1600.0*day,false));
//    fReportingTimes.Push(std::make_pair(s*1400.0*day,false));
//    fReportingTimes.Push(std::make_pair(s*1200.0*day,false));
    fReportingTimes.Push(std::make_pair(s*1000.0*day,true));
    fReportingTimes.Push(std::make_pair(s*900.0*day,true));
    fReportingTimes.Push(std::make_pair(s*800.0*day,true));
    fReportingTimes.Push(std::make_pair(s*700.0*day,true));
    ...
    fGammaIds.Push(bc_E);
    E[0] = std::make_pair(4,new TPZDummyFunction<REAL>(Impervious_3p));
    fIntial_bc_data.Push(E);
    E[0] = std::make_pair(4,new TPZDummyFunction<REAL>(Impervious_3p));
    fRecurrent_bc_data.Push(E);
    
//    fGammaIds.Push(bc_W);
//    W[0] = std::make_pair(0,new TPZDummyFunction<REAL>(PressureStatic_3p));
//    fIntial_bc_data.Push(W);
//    W[0] = std::make_pair(2,new TPZDummyFunction<REAL>(PressureInlet_3p));
//    fRecurrent_bc_data.Push(W);
//
//    fGammaIds.Push(bc_E);
//    E[0] = std::make_pair(0,new TPZDummyFunction<REAL>(PressureStatic_3p));
//    fIntial_bc_data.Push(E);
...
//    fRecurrent_bc_data.Push(E);
    ...
    fGammaIds.Push(bc_Prod);
    WPro[0] = std::make_pair(0,new TPZDummyFunction<REAL>(PressureStatic_3p));
    fIntial_bc_data.Push(WPro);
    ...
    fGammaIds.Push(bc_Inj);
    WInj[0] = std::make_pair(4,new TPZDummyFunction<REAL>(PressureStatic_3p));
    fIntial_bc_data.Push(WInj);
    WInj[0] = std::make_pair(2,new TPZDummyFunction<REAL>(PressureInlet_3p));
    fRecurrent_bc_data.Push(WInj);
    
}

void TRMRawData::PressureStatic_3p(const TPZVec< REAL >& pt, REAL time, TPZVec< REAL >& f, TPZFMatrix< REAL >& Gradf){
    
    REAL p = 2.5e+7,S_w = 0.0, S_o = 0.0;
    f[0] = p;
    f[1] = S_w;
    f[2] = S_o;
    return;
...
void TRMRawData::PressureInlet_3p(const TPZVec< REAL >& pt, REAL time, TPZVec< REAL >& f, TPZFMatrix< REAL >& Gradf){
    ...
    REAL p = 2.5e+7, S_w = 0.0, S_o = 0.0;// 1.0342e+7; // 1500 psi
    f[0] = p;
    f[1] = S_w;
    f[2] = S_o;
...
void TRMRawData::FluxInlet_3p(const TPZVec< REAL >& pt, REAL time, TPZVec< REAL >& f, TPZFMatrix< REAL >& Gradf){
    ...
    REAL flux = -1.84, S_w = 0.0, S_o = 0.0;
    f[0] = flux;
    f[1] = S_w;
    f[2] = S_o;
    return;
