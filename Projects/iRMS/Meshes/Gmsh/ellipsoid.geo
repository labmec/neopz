...
lidst1[] = Rotate {{0,0,1},{0,0,0},Pi/2} {Duplicata{Surface{as1,bs1};}}; 
lidst2[] = Rotate {{0,0,1},{0,0,0},Pi} {Duplicata{Surface{as1,bs1};}}; 
lidst3[] = Rotate {{0,0,1},{0,0,0},3*Pi/2} {Duplicata{Surface{as1,bs1};}};


wellbore_t1[] = Rotate {{0,0,1},{0,0,0},Pi/2} {Duplicata{Surface{cs1};}}; 
wellbore_t2[] = Rotate {{0,0,1},{0,0,0},Pi} {Duplicata{Surface{cs1};}}; 
wellbore_t3[] = Rotate {{0,0,1},{0,0,0},3*Pi/2} {Duplicata{Surface{cs1};}};


wellregion_t1[] = Rotate {{0,0,1},{0,0,0},Pi/2} {Duplicata{Surface{wr_as1,wr_bs1};}}; 
wellregion_t2[] = Rotate {{0,0,1},{0,0,0},Pi} {Duplicata{Surface{wr_as1,wr_bs1};}}; 
wellregion_t3[] = Rotate {{0,0,1},{0,0,0},3*Pi/2} {Duplicata{Surface{wr_as1,wr_bs1};}};
