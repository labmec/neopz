...
Point(1) = {0,0,0,lcar1};     Point(2) = {0,1,0,lcar1};
Point(3) = {1,1,0,lcar1};     Point(4) = {1,0,0,lcar1};
Point(5) = {0,0,1,lcar1};     Point(6) = {0,1,1,lcar1};
Point(7) = {1,1,1,lcar1};     Point(8) = {1,0,1,lcar1};
