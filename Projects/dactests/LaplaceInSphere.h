...
#ifndef __PZ__LaplaceInSphere__
#define __PZ__LaplaceInSphere__
...
class LaplaceInSphere{
private:
    const int fDim = 2;
    
    const int fmatId = 1;
    
    const int fdirichlet = 0;
    const int fneumann = 1;
...
#endif /* defined(__PZ__LaplaceInSphere__) */
