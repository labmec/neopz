...
//    BCond0 = material->CreateBC(mat, bc0,dirichlet, val1, val2);
    TPZAutoPointer<TPZFunction<STATE> > FBCond0 = new TPZDummyFunction<STATE>(ForcingBC0N);
...
//    TPZAutoPointer<TPZFunction<STATE> > FBCond4 = new TPZDummyFunction<STATE>(ForcingBC0N);
...
//    BCond5 = material->CreateBC(mat, bc5,dirichlet, val1, val2); //dirichlet
    TPZAutoPointer<TPZFunction<STATE> > FBCond5 = new TPZDummyFunction<STATE>(ForcingBC5N);
