...
//				
//				// Top Boundary			
//				TPZMaterial * BCTOP = materialist[imat]->CreateBC(mat, arc1,dirichlet, val1, val2);
//				cmesh->InsertMaterialObject(BCTOP);
//				
//				// Bottom Boundary			
//				TPZMaterial * BCBOTT = materialist[imat]->CreateBC(mat, arc2,dirichlet, val1, val2);
//				cmesh->InsertMaterialObject(BCBOTT);
//				
//				// Left Boundary			
//				TPZMaterial * BCLEFT = materialist[imat]->CreateBC(mat, arc3,dirichlet, val1, val2);
//				cmesh->InsertMaterialObject(BCLEFT);
//				
//				// Right Boundary			
//				TPZMaterial * BCRIGHT = materialist[imat]->CreateBC(mat, arc4,dirichlet, val1, val2);
...
//				
//				// Top Boundary			
//				TPZMaterial * BCTOP = mymaterial[imat]->CreateBC(mat, arc3, WichCase, val1AllContour, val2AllContour);
//				mphysics->InsertMaterialObject(BCTOP);
//				// Bottom Boundary		
//				TPZMaterial * BCBOTT = mymaterial[imat]->CreateBC(mat, arc3, WichCase, val1AllContour, val2AllContour);
//				mphysics->InsertMaterialObject(BCBOTT);
//				// Left Boundary		
//				TPZMaterial * BCLEFT = mymaterial[imat]->CreateBC(mat, arc3, WichCase, val1AllContour, val2AllContour);
//				mphysics->InsertMaterialObject(BCLEFT);
//				// Right Boundary		
//				TPZMaterial * BCRIGHT = mymaterial[imat]->CreateBC(mat, arc3, WichCase, val1AllContour, val2AllContour);
