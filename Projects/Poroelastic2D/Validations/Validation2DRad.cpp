...
//		void SolveSistTransient(int PrintEachtimeStep, std::string FileName, REAL deltaT,REAL maxTime, TPZFMatrix<REAL> &Initialsolution, TPZVec <TPZPoroElastic2d  * > &mymaterial , TPZAnalysis &an, TPZVec<TPZCompMesh *> meshvec, TPZCompMesh* mphysics);
...
//			//	mygenerator.SetfDimensionlessL(100000.0);
//			////	TPZGeoMesh * gmesh = mygenerator.GeometricGIDMesh("CirclePlanStrain.dump");
//			////	TPZGeoMesh * gmesh = mygenerator.GeometricGIDMesh("CirclePlanStrainCoarse.dump");	
//			//	TPZGeoMesh * gmesh = mygenerator.GeometricGIDMesh("CirclePlanStrainVeryCoarse.dump");
//			
//			
//			// Begin Circular geometric mesh using tpzarc3d
//			
//			MeshGeneration mygenerator;
//			TPZVec <int> matIdlist(10,0);
//			matIdlist[0]= matId;
//			matIdlist[1]= bcBottom;
//			matIdlist[2]= bcTop;
//			matIdlist[3]= bcRight;
//			matIdlist[4]= bcLeft;
//			matIdlist[5]= yfixedPoints;
//			matIdlist[6]= yfixedPoints;
//			matIdlist[7]= xfixedPoints;
//			matIdlist[8]= xfixedPoints;	
//			matIdlist[9]= WellLine;	
...
//			//	REAL Delta = 0.00001;
//			//	REAL MaxTime = 0.01;	
//			//	REAL Delta = 0.000000261749;
//			//	REAL MaxTime = 0.000261749;		
//			//	REAL Delta = 0.001*year;
//			//	REAL MaxTime = 1*year;
//			REAL Delta = 0.0164*day;
//			REAL MaxTime = 164*day;	
//			std::string	OutFileName("PoroelasticOutSolution");
//			//	REAL Theta = 1.0;
//			REAL Theta = 0.6667;	
...
//
//
//		void SolveSistTransient(int PrintEachtimeStep, std::string FileName, REAL deltaT,REAL maxTime, TPZFMatrix<REAL> &InitialSolution,TPZVec <TPZPoroElastic2d  * > &mymaterial, 
...
//			//	int NRows = PoroelasticMassMatrix->Rows(); 
//			//	TPZFMatrix<REAL> PoroelasticStiffnessMatrixInverse(NRows, NRows, 0.0);
//			//	an.Solver().Matrix()->Inverse(PoroelasticStiffnessMatrixInverse);
//			
//			// Printing Matrix
//			//#ifdef LOG4CXX
//			//	if(logdata->isDebugEnabled())
//			//	{
//			//		std::stringstream sout;
//			//		PoroelasticStiffnessMatrixInverse.Print("KStiffness = ", sout,EMathematicaInput);
...
//				//		PoroelasticStiffnessMatrixInverse.Multiply(TotalRhs,LastSolution);		
//				an.Rhs() = TotalRhs;
//				an.Solve(); 
...
//				if (PrintEachtimeStep == control) 
//				{
//					//			an.Solution() = LastSolution;
//					std::stringstream outputfiletemp;
