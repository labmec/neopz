...
//
//// Left Block 
//const int LBright = 21;
//const int LBleft = -4;
//const int LBBot = -1;
//const int LBTop = -3;
//
//// Graven Block 
//const int GBright = 41;
//const int GBleft = 21;
//const int GBBot = -1;
//const int GBTop = -3;
//
...
//		unitdis(1,0) = -10.0;		
//		
//		TPZMaterial * BCondNU = materialist[imat]->CreateBC(mat, bcTop,dirichlet, val1, unitdis);
//		cmesh->InsertMaterialObject(BCondNU);
//		
//		REAL uNLy=0.0;
//		val2(1,0)=uNLy;	
//		
//		TPZMaterial * BCondNL = materialist[imat]->CreateBC(mat, bcBottom,dirichlet, val1, unitdis);
...
//		REAL uDL=0.0;
//		val22(0,0)=uDL;
//		TPZMaterial * BCondDL = materialist[imat]->CreateBC(mat, bcLeft,dirichlet, val12, unitdis);
...
//		
//		
//		//	TPZElasticityMaterial *interfacemat = new TPZElasticityMaterial(41,100,0.35, 0.0, -gravity*2500.0, planestress); 
//		//	TPZMaterial * mat(interfacemat);
//		//	cmesh->InsertMaterialObject(mat);			
//		
//		
