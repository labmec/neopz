/**
 * @file TPZMatComplexExample.h
 * @brief Header file for class TPZMatComplexExample.\n
 * It implements the weak statement of the model problem from Oden's book, Chapter 1 within the PZ environment.
 */

#ifndef TPZMATCOMPLEXEXAMPLE_H
#define TPZMATCOMPLEXEXAMPLE_H
 ...
 */
class  TPZMatComplexExample : public TPZMaterial
{
...
public:
    TPZMatComplexExample(int id, REAL l, REAL t, REAL eO,STATE (& ur)( TPZVec<REAL>,REAL),STATE (& er)( TPZVec<REAL>,REAL));
  
    TPZMatComplexExample(int id);
  
    /** @brief Default constructor */
    TPZMatComplexExample();
    ...
    TPZMatComplexExample(const TPZMatComplexExample &mat);
    /** @brief Default destructor */
    virtual ~TPZMatComplexExample();
	
    /** @brief Returns the name of the material */
    virtual std::string Name() { return "TPZMatComplexExample"; }
