...
void VerificationCase4(bool IsDimensionlessQ);

int main()
{
    
    bool IsDimensionlessQ = true;
    VerificationCase4(IsDimensionlessQ);
...
void VerificationCase4(bool IsDimensionlessQ)
{
    ...
    REAL reservoir_pressure = 2.4132e7;
    
    TPZVec<REAL> rightbc(4,0.0);
    rightbc[0] = 2;
    rightbc[1] = (reservoir_pressure)/(Pstr); /* (3500 psi) */
    rightbc[2] = 0;
    rightbc[3] = 0;
    ...
    REAL well_radius = 0.127;
//    REAL reservoir_h = 200.0;
//    REAL production_rate = 1000.0*(0.1589873/day); /* 1000.0 bpd  (0.1589873/day) -> m3/s */
//    REAL sand_face_Area = 2.0*M_PI*well_radius;
//    REAL fluid_rho = 1000.0; /* kg/m3 */
//    REAL u_production = (production_rate/sand_face_Area)*fluid_rho;

    REAL wellbore_pressure = 1.03421e7;
    
    TPZVec<REAL> leftbc(4,0.0);
    leftbc[0] = 0;
    leftbc[1] = (wellbore_pressure)/(Pstr); /* (1500 psi) */
    leftbc[2] = (1.0 - S_nw_r);
    leftbc[3] = 0;
    ...
    Kabsolute.Zero();
    Kabsolute(0,0) = (1.0e-12)/Kstr;
    Kabsolute(1,1) = (1.0e-12)/Kstr;
