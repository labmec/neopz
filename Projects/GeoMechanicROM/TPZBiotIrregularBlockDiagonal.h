//
//  TPZBiotIrregularBlockDiagonal.h
//  PZ
//
...
#ifndef TPZBiotIrregularBlockDiagonal_h
#define TPZBiotIrregularBlockDiagonal_h
...
template <class TVar>
class TPZBiotIrregularBlockDiagonal : public TPZMatrix<TVar>
{
    
public:
    /** @brief Simple constructor */
    TPZBiotIrregularBlockDiagonal ();
    /**
     * @brief Constructor with initialization parameters
     * @param blocksizes Size of blocks on Block Diagonal matrix
     * @param glob Global matrix which will be blocked
     */
    TPZBiotIrregularBlockDiagonal (TPZVec< std::pair<long, long> > &blocksizes, const TPZFMatrix<TVar> &glob );
    /**
     * @brief Constructor with initialization parameters
     * @param blocksizes Size of blocks on Block Diagonal matrix
     */
    TPZBiotIrregularBlockDiagonal (TPZVec< std::pair<long, long> > &blocksizes);
    /** @brief Copy constructor */
    TPZBiotIrregularBlockDiagonal (const TPZBiotIrregularBlockDiagonal & );
    
    /** @brief Copy constructor */
    TPZBiotIrregularBlockDiagonal &operator=(const TPZBiotIrregularBlockDiagonal & copy)
    {
        DebugStop();
        return *this;
    }
    
    CLONEDEF(TPZBiotIrregularBlockDiagonal)
...
template<class TVar>
inline TVar &TPZBiotIrregularBlockDiagonal<TVar>::s(const long row, const long col) {
...
#endif /* TPZBiotIrregularBlockDiagonal_h */
