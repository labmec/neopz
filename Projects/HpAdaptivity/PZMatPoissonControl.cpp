...
void TPZMatPoissonControl::Solution(TPZVec<STATE> &Sol,TPZFMatrix<STATE> &DSol,TPZFMatrix<REAL> &axes,int var,TPZVec<STATE> &Solout){
...
//void TPZMatPoissonControl::ErrorsHdiv(TPZMaterialData &data,TPZVec<STATE> &u_exact,TPZFMatrix<STATE> &du_exact,TPZVec<REAL> &values){
//	
//    values.Fill(0.0);
...
void TPZMatPoissonControl::Errors(TPZVec<REAL> &x,TPZVec<STATE> &u,
