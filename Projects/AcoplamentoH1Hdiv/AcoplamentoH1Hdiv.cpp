...
TPZCompMesh *MalhaCompGen(TPZGeoMesh * gMesh, int porder)
{
        ...
        TPZAutoPointer<TPZFunction<STATE> > force = new TPZDummyFunction<STATE>(Forcing1, 5);
	...
	//	comp->CleanUpUnconnectedNodes();
		...
		for(int64_t el = 0; el < comp->ElementVec().NElements(); el++)
		{
